...
-(void)openUrl: (NSString*) url {
    self.webview = [[WKWebView alloc] initWithFrame:CGRectMake(0,0,self.bounds.size.width,self.bounds.size.height-60)];
...
-(void)home{
    if ([self.webview canGoBack]) {
        WKBackForwardListItem* backItem = self.webview.backForwardList.backList[0];
